                ...
                <li v-for="(goodDetail,index) in goodDetails" :key="goodDetail.id">
                    <div class="goodDetaiSwipe">
                        <mt-swipe :auto="4000">
                            ...
                            <mt-swipe-item> <img v-bind:src="goodDetail.imgFour" alt="图片"></mt-swipe-item>
                        </mt-swipe>
                    </div>
                    ...
                    <div class="goodDetailFooter">
                        <router-link class="box" :to="{name:'Home'}"exact tag="li">
                            <i class="iconfont icon-shouye"></i>
                            <div>首页</div>
                        </router-link>
                        <div>
                         <router-link class="box" :to="{name:'cart'}" tag="li">
