<template>
  <div class="Home">
      <div class="Homeheader"><img src="https://res.vmallres.com/pimages/temp/product/20170703105852645577.png" alt="logo"></div>
      <div class="official"><img src="/static/img/official.png" alt="图片" style="width: 100%;height:100%"></div>
      <div class="swipe">
        <mt-swipe :auto="4000">
          <mt-swipe-item><router-link to="goodDetail?id=4"><img src="https://res.vmallres.com/pimages//sale/2017-12/20171229185851779.png" alt="轮播图"></router-link></mt-swipe-item>
          <mt-swipe-item><router-link to="choose"><img src="https://res.vmallres.com/pimages//sale/2018-01/20180104162731261.png" alt="轮播图"></router-link></mt-swipe-item>
        </mt-swipe>
      </div>
      <div class="HomeList">
        <ul >
